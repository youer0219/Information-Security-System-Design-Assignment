...
- `TODO:做一些设计与建模相关的工作吧。目前的任务需要我整合模块了。当然，权限系统还需要学习。`
...
- 简化`公文建模`部分的公文设计，实际设计如下：
    ...
    - 这不是一个完美的公文建模，但是可以作为开始。后续可以参考[这个对话](https://kimi.moonshot.cn/share/ct5t5v95b5q2b8biklu0)进行修改。
        - `TODO:注意，这里标题的不可重复还没有应用，之前设置允许重复。`
...
- 与数据库进行连接
    ...
    - `TODO:目前都是封装成类，但似乎只需要调用方法就好。暂时保持类的设计，之后再重构。`
    - `TODO:参考其他项目，我应该也写一个数据库配置的SQL语句文件来。`
